    ...
    <section className='today_deal'>
                 <div className='deal_container max-w-bodyWidth mx-auto mt-[6em] pl-8'>
                       ...
                       <div className='flash_sales_cantainer mt-6 mb-10'>
                           <div className='flash_sales_row flex gap-[4rem]'>

                           <div className='flash_sales_title self-end'>
                               <h1 className='text-secondary font-primary text-2xl font-semibold leading-10'>Flash Sales</h1>
                           </div>
                           <div className='days_limit_offer flex gap-4'>
                               <div className='offer_days'>
                                   ...
                                   <p className='text-secondary font-primary text-3xl font-bold leading-8'>03 <span>:</span></p>
                               </div>
                               <div className='offer_hours'>
                                 <p className='text-secondary font-secondary text-xs leading-5 font-medium'>Hours</p>
                                 <p className='text-secondary font-primary text-3xl font-bold leading-8'>04  <span>:</span></p>
                               </div>
                               <div className='offer_minutes'>
                                  <p className='text-secondary font-secondary text-xs leading-5 font-medium'>Minutes</p>
                                  <p className='text-secondary font-primary text-3xl font-bold leading-8'>30 <span>:</span></p>
                               </div>
                               <div className='offer_seconds'>
                                   <p className='text-secondary font-secondary text-xs leading-5 font-medium'>Seconds</p>
                                   <p className='text-secondary font-primary text-3xl font-bold leading-8'>03</p>
                               </div>
                           </div>
                           </div>
                       </div>
                       ...
                       {/* product carousel */}
                       <div className='product_gallery flex justify-between items-center mb-14'>
                             {
                                products.slice(0, 5).map((product) =>{
                                  return(
                                    <div className='products grid gap-y-2' key={product.id} >
